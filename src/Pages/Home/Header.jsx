...
function Header() {
  return (
    <div className="py-5 px-7">
      <header className="flex text-slate-700 gap-5 sm:gap-0 mb-4 sm:mb-0 flex-col-reverse sm:flex-row  justify-evenly  items-center text-center relative">
        <div className="grid gap-5 ">
          <h1 className="text-3xl md:text-5xl text-center uppercase font-takur">
            special spot specilizing in giving you the best meal{" "}
          </h1>
          <Button path="/menu" style="mx-auto  px-2 rounded">
            view menu
          </Button>
        </div>
        <img
        ...
        />
        {/* <img
          className="rounded-[50%] w-60 absolute "
      ...
      <section className="flex md:justify-evenly items-center flex-col justify-between md:flex-row gap-4 md:gap-0">
        ...
        <div className="text-slate-500 md:w-2/5 w-full grid grid-row-3 gap-5">
          <h1 className="text-slate-700 text-xl font-Inter font-semibold">
            Welcome to Foodies
          </h1>
          ...
          <Button path="/menu" style="py-1 px-2" to="menu">
            order now
          </Button>
        </div>
      </section>
